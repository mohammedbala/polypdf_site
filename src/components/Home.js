...
const screenshots = [
  ...
  },
  {
    ...
    caption: 'A revision cloud around the storage room, a callout with a leader, and live measurements — placed with the same keyboard shortcuts Revu users already know.'
  },
  {
    image: shotSearch,
    title: 'Search the sheet, see it in context',
    caption: 'Text search finds "OCCUPANCY SENSORS" in the general notes and highlights it on the page.'
  }
];
