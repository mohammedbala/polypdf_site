...
const sections = [
  {
    ...
    content: [
      ...
      'Google Analytics, Google Ads, and OpenAI Ads measure website visits, acquisition sources, and completed purchases. OpenAI Ads may store an opaque ad-click reference in a first-party browser cookie. A completed-purchase event contains a Stripe transaction identifier, order value, currency, and product name, but not your email address, license key, document name, or document content.',
        ...
        <div className="container">
          ...
          <section className="legal-section">
            ...
            <ul className="section-content">
              ...
              <li>Google Analytics, Google Ads, and OpenAI Ads may store browser identifiers used to attribute a visit and a completed purchase. You can clear or block these identifiers through your browser settings.</li>
